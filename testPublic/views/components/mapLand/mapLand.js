...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    watch: {
	        isAllAirline: function isAllAirline(val) {
	            this.showAll(val);
	        },
	        isFocusing: function isFocusing(val) {
	            if (val && activeData) {
	    ...
	    methods: {
	        ...
	        showThisAirline: function showThisAirline(index) {
	        ...
	        getBaseLandData: function getBaseLandData(data) {
	            return {
	                title: data.title,
	                type: data.type,
	        ...
	        setBlockActive: function setBlockActive(data, autofit) {
	            ...
	            if (data == activeData) {
	                ...
	                if (this.CHeight == document.documentElement.clientHeight) {
	        ...
	        getOptionByType: function getOptionByType(type) {
	            var option;
	            switch (type) {
	                case 0:
	    ...
	    ready: function ready() {
	        ...
	        var _this = this,
	            featureGroupNumber = L.featureGroup([]);
