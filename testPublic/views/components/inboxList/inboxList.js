...
/***/ function(module, exports, __webpack_require__) {
	...
	var inboxListComponent = Vue.extend({
	    ...
	    filters: {
	        ...
	        getMapStatus: function getMapStatus(val) {
	    ...
	    methods: {
	        dispathEventAndClose: function dispathEventAndClose(event, data) {
	            // console.log("dispathEventAndClose"+event);
	            this.$dispatch(event, data);
	        },
	        pagingClick: function pagingClick() {
	            // console.log("pagingClick" + this.datas.length);
	            this.$dispatch('inboxList-paging', this.datas.length);
	        },
	        gotoDetailEvent: function gotoDetailEvent(app_uid) {
	            this.$dispatch('gotoDetailEvent', { app_uid: app_uid });
	        },
	        dispathEvent: function dispathEvent(event, item) {
